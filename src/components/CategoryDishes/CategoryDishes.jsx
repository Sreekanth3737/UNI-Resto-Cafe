        ...
        : props.dishes.map((item, index) => {
            return (
              <div className="cart_box container mx-auto" key={index}>
                <div>
                  <h1 className=" text-zinc-600 shadow-sm font-serif text-2xl ">
                    {item?.dish_name}
                  </h1>
                  ...
                  <h4 className="text-zinc-500 font-sans">
                ...
                <div className="flex ">
                  <h3 className="text-zinc-500 font-medium mx-5 text-center  justify-end">
